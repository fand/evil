...
(function (e) {
  function u(q, a, g, k) {
    var i = a.button || g.button,
      n = a.url || g.url,
      o = a.provider_name || g.provider_name,
      p = a.suggest_notebook || g.suggest_notebook,
      r = a.content_id || g.content_id,
      s = a.code || g.code,
      t = a.title || g.title,
      m = a.suggest_tags || g.suggest_tags,
      a = a.styling || g.styling;
    if (
      'article-clipper' == i ||
      'article-clipper-remember' == i ||
      'article-clipper-jp' == i ||
      'article-clipper-rus' == i ||
      'article-clipper-fr' == i ||
      'article-clipper-es' == i ||
      'article-clipper-de' == i ||
      'article-clipper-vert' == i ||
      'site-mem-32' == i ||
      'site-mem-36' == i ||
      'site-mem-22' == i ||
      'site-mem-16' == i
    )
      i = 'http://static.evernote.com/' + i + '.png';
    var d = {
      url: n,
      providerName: o,
      suggestNotebook: p,
    ...
    k = e(document.createElement('a'))
      .attr({ href: '#' })
      .click(function () {
        Evernote && Evernote.doClip(d);
        return !1;
      })
      .append(
        '<img src="' + i + '" alt="Clip to Evernote" style="border: none" />'
      );
    e(q).html(k);
  }
  function n(e) {
  ...
  function k(e) {
    var a = [
      ...
      g;
    for (g in a) e = e.replace(a[g][0], a[g][1]);
    return e;
  }
  function o(e) {
  ...
  e.fn.socialbutton = function (q, a) {
    var a = a || {},
      g = document.URL,
      v = document.URL,
      i = document.URL,
    ...
    return this.each(function (d) {
      switch (q) {
        case 'mixi_check':
          ...
          '' != b &&
            ((b =
              ...
              n({ 'data-key': b, 'data-url': k(c), 'data-button': h }) +
              '>Check</a>'),
            e(this).html(b),
            d == m &&
              e('body').append(
        ...
        case 'mixi_like':
          var c = a.key || '',
            f = a.url || g,
            d = void 0 != a.width ? a.width : 0,
            b = void 0 != a.height ? a.height : 0,
            l = void 0 != a.show_faces ? a.show_faces : !0,
            h = a.style || '';
          '' != c &&
            (a.url && (f = decodeURIComponent(f)),
            (f = o(f)),
            0 == d && (d = l ? 450 : 140),
            0 == b
              ? (b = l ? 80 : 20)
            ...
            (c = p({
              ...
              service_key: c,
              width: d,
              show_faces: l ? 'true' : 'false',
            })),
            (d =
              '<iframe' +
              n({
                src: 'http://plugins.mixi.jp/favorite.pl?' + c,
                scrolling: 'no',
                frameborder: '0',
                allowTransparency: 'true',
                style:
                  'border:0; overflow:hidden; width:' +
                  d +
                  'px; height:' +
                  b +
                  'px; ' +
          ...
          break;
        case 'facebook_like':
          var d = a.layout || a.button || 'standard',
            b = a.url || v,
            h = void 0 != a.show_faces ? a.show_faces : !0,
            c = void 0 != a.width ? a.width : 0,
            f = void 0 != a.height ? a.height : 0,
            l = a.action || 'like',
            j = a.locale || '',
            z = a.font || '',
            A = a.colorscheme || 'light';
          a.url && (b = decodeURIComponent(b));
          b = o(b);
          switch (d) {
            case 'standard':
              0 == c ? (c = 450) : 225 > c && (c = 225);
              0 == f ? (f = h ? 80 : 35) : 35 > f && (f = 35);
              break;
            case 'button_count':
              0 == c ? (c = 120) : 90 > c && (c = 90);
              0 == f ? (f = 25) : 25 > f && (f = 25);
        ...
        case 'facebook_share':
          ...
          b =
            '<a name="fb_share"' +
            n({
              type: a.type || a.button || 'button_count',
              share_url: k(a.url || ''),
            }) +
            '>' +
            b +
        ...
        case 'twitter':
          ...
          b =
            ...
            n({
              'data-count': a.count || a.button || 'vertical',
              'data-url': k(a.url || ''),
              'data-text': b,
              'data-lang': h,
              'data-via': c,
        ...
        case 'gree_sf':
          d = a.type || a.button || 0;
          b = a.url || i;
          h = void 0 != a.width ? a.width : 0;
          c = void 0 != a.height ? a.height : 20;
          a.url && (b = decodeURIComponent(b));
          b = o(b);
          switch (d) {
            case 0:
        ...
        case 'hatena':
          ...
          d =
            '<a' +
            n({
              href: 'http://b.hatena.ne.jp/entry/' + b,
              class: 'hatena-bookmark-button',
              'data-hatena-bookmark-title': h,
              'data-hatena-bookmark-layout': d,
              title:
                '\u3053\u306e\u30a8\u30f3\u30c8\u30ea\u30fc\u3092\u306f\u3066\u306a\u30d6\u30c3\u30af\u30de\u30fc\u30af\u306b\u8ffd\u52a0',
            }) +
            '><img src="http://b.st-hatena.com/images/entry-button/button-only.gif" alt="\u3053\u306e\u30a8\u30f3\u30c8\u30ea\u30fc\u3092\u306f\u3066\u306a\u30d6\u30c3\u30af\u30de\u30fc\u30af\u306b\u8ffd\u52a0" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="http://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"><\/script>';
          e(this).html(d);
          break;
        case 'hatena_oldstyle':
          d = a.button || 'http://d.hatena.ne.jp/images/b_append.gif';
          b = a.url || s;
          h = void 0 != a.height ? a.height : 13;
          c = void 0 != a.padding ? a.padding : 7;
          b = k(b);
          e(this).html(
            '<span style="font-size: ' +
              h +
              'px; line-height: 100%; "><span style="padding-right: ' +
              c +
              'px"><a href="http://b.hatena.ne.jp/entry/add/' +
              b +
              '" target="_blank"><img src="' +
              d +
              '" style="border: none; vertical-align: text-bottom" /></a></span><a href="http://b.hatena.ne.jp/entry/' +
              b +
              '" target="_blank"><img src="http://b.hatena.ne.jp/entry/image/' +
              b +
        ...
        case 'google_plusone':
          j = a;
          if (!(e.browser.msie && 8 > parseInt(e.browser.version, 10))) {
            c = j.size || j.button || '';
            f = j.href || j.url || '';
            b = j.lang || '';
            h = j.parsetags || '';
            l = j.callback || '';
            j = void 0 != j.count ? j.count : !0;
            switch (c) {
              case 'small':
              case 'standard':
              case 'medium':
            ...
            d == m &&
              ...
              '' != h &&
                (d = d + ('' != d ? ',' : '') + ('parsetags: "' + k(h) + "'")),
              '' != d && (d = '{' + d + '}'),
              'undefined' === typeof gapi || 'undefined' === typeof gapi.plusone
                ? e('body').append(
        ...
        case 'pinterest':
          ((b = a.url || t),
            (h = a.button || 'horizontal'),
            (c = void 0 != a.media ? a.media : ''),
            (f = void 0 != a.description ? a.description : ''),
            (b = o(decodeURIComponent(b))),
            (c = o(decodeURIComponent(c))),
            (f = decodeURIComponent(f)),
            (b =
              '<a href="http://pinterest.com/pin/create/button/?' +
              p({ url: b, media: c, description: f }) +
...
(function () {
  ...
  this.Reverb = (function (_super) {
    ...
    Reverb.prototype.setIR = function (name) {
      ...
      req.onload = function () {
        return _this.ctx.decodeAudioData(
          req.response,
          function (buffer) {
...
(function () {
  ...
  this.Mixer = (function () {
    ...
    Mixer.prototype.drawGains = function () {
      ...
      for (
        i = _i = 0, _ref = this.analysers.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
    ...
    Mixer.prototype.setGains = function (gain_tracks, gain_master) {
      ...
      for (
        i = _i = 0, _ref = this.gain_tracks.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
    ...
    Mixer.prototype.setPans = function (pan_tracks, pan_master) {
      ...
      _results = [];
      for (
        i = _i = 0, _ref = this.pan_tracks.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
...
(function () {
  ...
  TIMER_PATH =
    (_ref = (_ref1 = this.URL) != null ? _ref1 : this.webkitURL) != null
      ? _ref.createObjectURL(
          (function () {
            try {
...
(function () {
  ...
  this.Player = (function () {
    ...
    Player.prototype.readSong = function (song) {
      ...
      this.view.empty();
      for (
        i = _i = 0, _ref = this.song.tracks.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
        if (
      ...
      for (
        i = _j = 0, _ref1 = this.song.tracks.length;
        0 <= _ref1 ? _j < _ref1 : _j > _ref1;
        i = 0 <= _ref1 ? ++_j : --_j
      ) {
...
(function () {
  ...
  this.SampleNode = (function () {
    function SampleNode(ctx, id, parent) {
      ...
      ((_ref = [
        ...
        (eq2 = _ref[1]),
        (eq3 = _ref[2]));
      ((_ref1 = ['lowshelf', 'peaking', 'highshelf']),
        (eq1.type = _ref1[0]),
        (eq2.type = _ref1[1]),
        (eq3.type = _ref1[2]));
      ((_ref2 = [0.6, 0.6, 0.6]),
        ...
        (eq3.Q.value = _ref2[2]));
      ((_ref3 = [350, 2000, 4000]),
        (eq1.frequency.value = _ref3[0]),
        (eq2.frequency.value = _ref3[1]),
        (eq3.frequency.value = _ref3[2]));
      ((_ref4 = this.eq_gains),
        (eq1.gain.value = _ref4[0]),
        (eq2.gain.value = _ref4[1]),
        (eq3.gain.value = _ref4[2]));
    ...
    SampleNode.prototype.setEQParam = function (eq_gains) {
      ...
      return (
        ...
        (this.eq_nodes[0].gain.value = _ref[0]),
        (this.eq_nodes[1].gain.value = _ref[1]),
        (this.eq_nodes[2].gain.value = _ref[2]),
        _ref
      );
    };
  ...
  this.Sampler = (function () {
    ...
    Sampler.prototype.addNote = function (time, note, gain) {
      ...
      for (
        i = _i = 0, _ref = this.pattern[time].length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
    ...
    Sampler.prototype.removeNote = function (pos) {
      ...
      _results = [];
      for (
        i = _i = 0, _ref = this.pattern[pos.x_abs].length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
...
(function () {
  this.SamplerCoreView = (function () {
        ...
        .on('mousemove', function (e) {
          ...
          if (_this.target_wave != null) {
            ...
            if (_this.target_wave === 'head') {
              ...
              d = Math.max(
                Math.min(d, _this.w_wave - _this.tail_wave),
                -_this.head_wave
              );
              _this.head_wave += d;
              _this.tail_wave += d;
    ...
    SamplerCoreView.prototype.fetchGains = function () {
      ...
      _results = [];
      for (
        i = _i = 0, _ref = this.gain_inputs.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
        _results.push(
  ...
  this.SamplerView = (function () {
    ...
    SamplerView.prototype.initCanvas = function () {
      ...
      for (
        i = _i = 0, _ref = this.cells_y;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
        for (
          j = _j = 0, _ref1 = this.cells_x;
          0 <= _ref1 ? _j < _ref1 : _j > _ref1;
          j = 0 <= _ref1 ? ++_j : --_j
        ) {
      ...
      this.canvas_hover_dom
        .on('mousemove', function (e) {
          ...
          if (pos !== _this.hover_pos) {
            _this.ctx_hover.clearRect(
              _this.hover_pos.x * 26,
              _this.hover_pos.y * 26,
              26,
              26
            );
            _this.ctx_hover.drawImage(
              _this.cell,
              52,
              26,
              26,
...
(function () {
  ...
  this.Session = (function () {
    ...
    Session.prototype.savePatterns = function () {
      ...
      _results = [];
      for (
        i = _i = 0, _ref = this.current_cells.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
    ...
    Session.prototype.saveTracks = function () {
      ...
      _results = [];
      for (
        i = _i = 0, _ref = this.player.synth.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
    ...
    Session.prototype.changeSynth = function (id, type, synth_new) {
      ...
      ((_ref = [
        ...
        (this.song.tracks[id].patterns[0] = _ref[0]),
        (this.song.tracks[id].patterns[this.current_cells[id]] = _ref[1]));
  ...
  this.SessionView = (function () {
    ...
    SessionView.prototype.initEvent = function () {
      ...
      this.wrapper_master.on('scroll', function (e) {
        return _this.wrapper_tracks_sub.scrollTop(
          _this.wrapper_master.scrollTop()
        );
      });
      this.wrapper_tracks_sub.on('scroll', function (e) {
        return _this.wrapper_master.scrollTop(
          _this.wrapper_tracks_sub.scrollTop()
        );
      });
      ...
      this.dialog.on('mousedown', function (e) {
        if (
          !_this.dialog_wrapper.is(e.target) &&
          _this.dialog_wrapper.has(e.target).length === 0
        ) {
    ...
    SessionView.prototype.readSong = function (song, current_cells) {
      ...
      this.resize();
      for (
        x = _i = 0, _ref = Math.max(this.song.tracks.length + 1, 8);
        0 <= _ref ? _i < _ref : _i > _ref;
        x = 0 <= _ref ? ++_i : --_i
      ) {
        ...
        for (
          y = _j = 0, _ref1 = Math.max(this.song.length + 1, 10);
          0 <= _ref1 ? _j < _ref1 : _j > _ref1;
          y = 0 <= _ref1 ? ++_j : --_j
        ) {
      ...
      this.drawMasterName();
      for (
        y = _k = 0, _ref2 = Math.max(this.song.length + 1, 10);
    ...
    SessionView.prototype.drawDrag = function (ctx, pos) {
      ...
      if (
        this.song.tracks[this.click_pos.x].patterns[this.click_pos.y] == null
      ) {
        return;
      }
    ...
    SessionView.prototype.cueTracks = function (x, y) {
      ...
      if (
        ...
        return window.setTimeout(function () {
          return _this.ctx_tracks_on.clearRect(
            x * _this.w + 4,
            y * _this.h + 4,
            15,
            16
    ...
    SessionView.prototype.beat = function (is_master, cells) {
      ...
      if (is_master) {
        ...
        return window.setTimeout(function () {
          return _this.ctx_master_on.clearRect(
            c[0] * _this.w + 3,
            c[1] * _this.h + 3,
            16,
            15
...
(function () {
  ...
  this.SynthCore = (function () {
    ...
    SynthCore.prototype.setVCOParam = function (
      i,
      shape,
      oct,
      interval,
    ...
    SynthView.prototype.initEvent = function () {
      ...
      this.canvas_hover_dom
        ...
        .on('mousedown', function (e) {
          ...
          if (!_this.is_step) {
            if (
              _this.pattern[pos.x_abs] === 'sustain' ||
              _this.pattern[pos.x_abs] === 'end'
            ) {
              _this.addNote(pos);
